...
public class RepoHelper {
	...
	public User getUserProfile(HttpServletRequest request) {
		...
		User profile = repo.findByEmail(getUsernameFromToken(request));
		System.out.println(profile.getEmail());
		return profile;
	}

	public TempUserProfile getTempUserProfile(HttpServletRequest request) {
		System.out.println(getUsernameFromToken(request));
		TempUserProfile profile = userProfileRepository.findByEmail(getUsernameFromToken(request));
		System.out.println(profile.getEmail());
		return profile;
	}
